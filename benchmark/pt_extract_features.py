...
import pt_resnet_feature_extractor
...
def run_pt_feature_extractor(newt_dataset_dir, fg_datasets, newt_features_dir, fg_features_dir, feature_extractor_batch_size=64, overwrite=False):
...
if __name__ == '__main__':
    ...
    assert args.newt_feature_dir != args.fg_feature_dir, "The NeWT and FG feature directories need to be distinct (the resulting feature filenames will clash...)"
